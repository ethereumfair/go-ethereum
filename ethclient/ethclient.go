...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, dogecoin.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*dogecoin.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (dogecoin.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q dogecoin.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q dogecoin.FilterQuery, ch chan<- types.Log) (dogecoin.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q dogecoin.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg dogecoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg dogecoin.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg dogecoin.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*dogecoin.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg dogecoin.CallMsg) (uint64, error) {
...
func toCallArg(msg dogecoin.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *dogecoin.SyncProgress {
	if p == nil {
		return nil
	}
	return &dogecoin.SyncProgress{
